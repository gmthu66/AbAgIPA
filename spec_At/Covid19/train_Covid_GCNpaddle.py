...
from SabDab.modelSab.AtAbIPA_GNNpaddle import FAbAtInterGCN
...
def init_config(config):
    ...
    config.par_out_dir = osp.join(spect_AtDir, f'trained_models/GCNpaddle_Glbmax_{config.embed_type}')
