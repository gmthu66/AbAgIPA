...
from SabDab.modelSab.IPA_paddle import IPA_Paddle
...
def init_config(config):
    ...
    config.par_out_dir = osp.join(spect_AtDir, f'trained_models/test_IPA_Paddle_{config.embed_type}')
...
def init_from_ckpt(model_ckpt, user_config=None):
    ...
    Model = FAbAtInter if user_config.embed_type is 'Bert' else IPA_Paddle
