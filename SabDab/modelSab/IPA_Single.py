...
class IPA_single(pl.LightningModule):
    ...
    def forward(
        ...
        ab_str_nodes = self.Ab_template_ipa(ab_str_nodes, translations=Ab_dumy_translations, rotations=Ab_dumy_rotations, pairwise_repr=None, mask=Ab_res_batch_mask)
