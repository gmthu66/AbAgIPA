...
class IPA_PaddleWithPoint(pl.LightningModule):
    ...
    def __init__(
        ...
        if self.node_dim < 36:
            ...
            self.esm_attn_dim = self.esm_feat_dim * 2
    ...
    def forward(
        ...
        at_str_nodes = self.Ab_template_ipa(at_str_nodes, translations=At_truth_translations, rotations=At_truth_rotations, pairwise_repr=at_str_edges, mask=At_res_batch_mask)
