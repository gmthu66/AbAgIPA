...
from model.components import TriangleGraphTransformer, IPAEncoder, IPATransformer, InterEdge
...
class FAbAtInter(pl.LightningModule):
    ...
    def forward(
        ...
        Ab_cdr_indexs = data.Ab_cdr_indexs
        ...
        inter_feat = self.inter_layer(inter_edges, ab_mask=res_batch_mask, at_mask=At_res_batch_mask)
