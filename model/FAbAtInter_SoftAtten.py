...
from model.components import TriangleGraphTransformer, IPAEncoder, IPATransformer, Inter_SoftAtten
...
class FAbAtInter(pl.LightningModule):
    ...
    def __init__(
        ...
        self.inter_layer = Inter_SoftAtten(dim=self.node_dim, hdim=self.node_dim, head=1)
