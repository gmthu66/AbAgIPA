...
from model.components.IPABlock_ForInter import IPABlock_ForInter
...
class IPAEncoder_ForInter(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for _ in range(depth):
            self.layers.append(IPABlock_ForInter(
                dim=dim,
    ...
    def forward(
        ...
        *,
        ...
        if not self.return_attn:
            ...
            return x, attn_res, attn_points


class IPATransformer_ForInter(nn.Module):
    def __init__(
        self,
        *,
        dim,
