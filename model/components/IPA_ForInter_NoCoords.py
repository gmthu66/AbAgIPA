...
from model.components.IPABlock_ForInter_NoCoords import IPABlock_ForInterNoCoords
...
class IPAEncoder_ForInter_NoCoords(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for _ in range(depth):
            self.layers.append(IPABlock_ForInterNoCoords(
                dim=dim,
                **kwargs,
            ))
...
class IPATransformer_ForInter_NoCoords(nn.Module):
    def __init__(
        self,
        *,
        dim,
        ...
        **kwargs,
        ...
        self.layers = nn.ModuleList([])
        for _ in range(depth):
            ipa_block = IPABlock_ForInterNoCoords(
                dim=dim,
                **kwargs,
